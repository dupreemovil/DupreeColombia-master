...
public class MH_Adapter_Offers extends RecyclerView.Adapter<MH_Adapter_Offers.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tvValor.setText("$ ".concat(formatter.format(Float.parseFloat(listFilter.get(position).getValor()))));
        ...
        holder.tvValorDescuento.setText("$ ".concat(formatter2.format(Float.parseFloat(listFilter.get(position).getValor_descuento()))));
