...
import com.dupreinca.dupree.ActualizarService;
...
public class MH_ManagerNotificacion {
    ...
    public void showNotificationCompat(Context myContext, int id_session, Intent myIntent, int iconId, Bitmap largeIcon, String title, String contentText){
        ...
        Intent intent = new Intent(myContext, ActualizarService.class);

        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        PendingIntent pendingIntentActual = PendingIntent.getActivity(myContext,0,intent,PendingIntent.FLAG_ONE_SHOT);
        ...
        NotificationCompat.Builder notificationBuilder
                ...
                .addAction(new android.support.v4.app.NotificationCompat.Action(
                        R.mipmap.ic_launcher,"Actualizar",pendingIntentActual
                ))
