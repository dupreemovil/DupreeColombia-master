...
import com.dupreinca.dupree.mh_utilities.CustomViewPager_DisableSwipe;
...
public class Incorp_Todos_Fragment extends Fragment {
        ...
        public void onPageSelected(int position) {
            ...
            switch (position){
                ...
                case MH_PagerAdapter_Incorporacion.PAGE_INCRIPCION:
                    ...
                    adapterFragIncorp.getInscripcionFragment().loadData(nombre!=null ? nombre : "",cedula!=null ? cedula :"", modeEdit, metodo,tipoDocumento);
                    //setSelectedItem(R.id.navigation_asesora);
                    break;
            }
        }
    ...
    public String metodo="", tipoDocumento="";
    public void gotoPageInscription(String nombre, String cedula, boolean modeEdit, String metodo, String tipoDocumento){
        this.nombre = nombre;
        this.cedula = cedula;
